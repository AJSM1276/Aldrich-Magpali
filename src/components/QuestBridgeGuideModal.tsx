    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-[#FCFCFB]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 text-gray-500 hover:text-black rounded hover:bg-gray-100 transition-colors text-xs flex items-center gap-1"
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-12 overflow-hidden">
          ...
          <div className="md:col-span-4 border-r border-gray-200 overflow-y-auto p-4 space-y-2 bg-[#FCFCFB]">
            <div className="text-[10px] font-bold uppercase tracking-wider text-gray-500 px-2 mb-2">
              Table of Contents
            </div>
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3.5 rounded-sm transition-all border flex items-center justify-between ${
                    isSelected
                      ? 'bg-purple-50/80 border-purple-300 text-[#3C225D] shadow-2xs'
                ...
                >
                  ...
                  <ChevronRight className={`w-4 h-4 shrink-0 transition-transform ${isSelected ? 'text-[#3C225D] translate-x-0.5' : 'text-gray-300'}`} />
                </button>
              );
            })}
          </div>
          ...
          <div className="md:col-span-8 overflow-y-auto p-6 sm:p-10 bg-white space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="px-2.5 py-0.5 text-[10px] font-bold uppercase rounded-sm bg-purple-50 text-[#3C225D] border border-purple-200/80">
            ...
            <div className="p-4 sm:p-5 rounded-md bg-purple-50/60 border border-purple-200/80">
              <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#3C225D] mb-2.5 flex items-center gap-1.5">
                <Lightbulb className="w-3.5 h-3.5 text-[#3C225D]" />
            ...
            <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
              <button
                ...
                className="px-4 py-2 text-xs font-medium border border-gray-200 rounded-sm disabled:opacity-30 hover:bg-gray-50 transition-colors"
              >
                Previous Chapter
              </button>
              ...
              <button
                ...
                className="px-4 py-2 text-xs font-medium bg-[#1A1A1A] hover:bg-[#3C225D] text-white rounded-sm disabled:opacity-30 transition-colors shadow-2xs"
              >
                Next Chapter
              </button>
            </div>
